...
public class PlayerController : MonoBehaviour
{
    ...
    // The current move direction of a player, does NOT include magnitude 
    ...
    private void Awake() {
    	...
    	for (int i = 0; i < m_Attacks.Length; i++) {
    		...
    		if (attack.WindUpTime > attack.FrozenTime) {
    			Debug.LogError(attack.AttackName + "has a wind up time that is longer than the time the player is frozen for");
    		}
    	}
    }
    private void Start() {
